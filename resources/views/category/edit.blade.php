                ...
                <div class="card-body">
                    ...
                    <form action="{{route('category.update',$category->id)}}" class="mb-3" method="post">
                        ...
                        <div class="form-inline">
                            <input type="text" name="category" placeholder="New Category" value="{{ old("category",$category->title) }}" class="form-control form-control-lg @error('category') is-invalid @enderror mr-2" required>
